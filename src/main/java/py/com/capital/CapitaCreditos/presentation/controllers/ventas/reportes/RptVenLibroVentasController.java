package py.com.capital.CapitaCreditos.presentation.controllers.ventas.reportes;
...
public class RptVenLibroVentasController {
    ...
    public ParametrosReporte getParametrosReporte() {
        if (Objects.isNull(parametrosReporte)) {
            ...
            parametrosReporte.setReporte("VenLibroVentas");
        }
