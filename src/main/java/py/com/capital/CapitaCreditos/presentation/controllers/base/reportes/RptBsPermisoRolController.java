...
public class RptBsPermisoRolController {
    ...
    public void downloadReport() {
        ...
        /* si usamos JS no es para xls
            //descomentar esto si quieres previsalizar primero el archivo tener en cuenta que debes permitir popups
        ...
        */
        ...
        if (parametrosReporte.getFormato() == null) {
            if (parametrosReporte.getFormato().equalsIgnoreCase("PDF")) {
                scriptJs = this.generarReporte.openAndPrintReportWithJS(parametrosReporte);
            } else {
