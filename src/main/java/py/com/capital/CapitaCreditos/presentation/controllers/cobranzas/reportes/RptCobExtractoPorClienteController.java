package py.com.capital.CapitaCreditos.presentation.controllers.cobranzas.reportes;
...
public class RptCobExtractoPorClienteController {
    ...
    public ParametrosReporte getParametrosReporte() {
        if (Objects.isNull(parametrosReporte)) {
            ...
            parametrosReporte.setReporte("CobExtractoPorCliente");
        }
